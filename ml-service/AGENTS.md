...
`ml-service/` contains the Python ML component for the SIH IPsec VPN security analyzer. Python is used only for ML. The Go backend remains responsible for networking, packet handling, IPsec/IKE protocol facts, and security assessment logic.
