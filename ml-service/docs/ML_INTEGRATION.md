...
The default endpoint is `127.0.0.1:50051` over insecure gRPC. Configure the bind address and port in `ml-service/config/model.yaml`:
...
protoc -I ml-service/proto \
  ...
  ml-service/proto/ml/v1/traffic_classifier.proto
```
