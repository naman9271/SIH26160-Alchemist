...
export function MeshGradientSVG() {
  ...
  return (
    ...
    >
      <svg ref={signalRef} xmlns="http://www.w3.org/2000/svg" width="231" height="289" viewBox="0 0 231 289" className="h-auto w-full text-slate-950" aria-label="Animated IPSEC PRISM signal">
        <defs>
