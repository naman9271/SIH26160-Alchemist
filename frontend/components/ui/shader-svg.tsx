...
export function MeshGradientSVG() {
  ...
  useEffect(() => {
    const rect = document.querySelector("svg[aria-label='Animated Alchemist signal']")?.getBoundingClientRect();
    if (!rect) return;
  ...
  return (
    ...
    >
      <svg xmlns="http://www.w3.org/2000/svg" width="231" height="289" viewBox="0 0 231 289" className="h-auto w-full text-slate-950" aria-label="Animated Alchemist signal">
        <defs>
