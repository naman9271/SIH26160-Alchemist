  ...
  return (
    <header className={`${overlay ? "absolute" : "relative"} inset-x-0 top-0 z-30 border-b border-white/20 bg-black/75 font-mono text-white backdrop-blur-sm`}>
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-5 px-4 py-3.5 lg:px-8 lg:py-4">
        <Link href="/" aria-label="Alchemist home" className="shrink-0 rounded-sm border border-transparent px-2.5 py-2 text-white/78 transition-all duration-300 hover:border-teal-200/40 hover:bg-teal-200/[.06] hover:text-teal-100 hover:shadow-[0_0_24px_rgba(94,234,212,.18)]"><span className="text-xl font-bold italic tracking-widest [transform:skewX(-12deg)] lg:text-2xl">ALCHEMIST</span></Link>
        ...
        <Link href="/workspace" className="group relative shrink-0 overflow-hidden border border-white/70 bg-white/10 px-4 py-2.5 text-[10px] font-bold tracking-[.14em] text-white shadow-[0_0_28px_rgba(255,255,255,.12)] backdrop-blur-sm transition-all duration-300 hover:border-teal-200 hover:bg-teal-200/15 hover:text-teal-100 hover:shadow-[0_0_38px_rgba(94,234,212,.28)] focus-visible:border-teal-200 focus-visible:bg-teal-200/15 focus-visible:text-teal-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-100/70"><span className="absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-teal-100/25 to-transparent transition-transform duration-700 group-hover:translate-x-full group-focus-visible:translate-x-full" /><span className="absolute -left-1 -top-1 hidden h-3 w-3 border-l border-t border-white/70 group-hover:border-teal-100 group-focus-visible:border-teal-100 lg:block" /><span className="absolute -bottom-1 -right-1 hidden h-3 w-3 border-b border-r border-white/70 group-hover:border-teal-100 group-focus-visible:border-teal-100 lg:block" /><span className="relative">OPEN WORKSPACE</span></Link>
      </div>
    </header>
  );
}
