        ...
        <div className="mx-auto w-full max-w-7xl px-6 lg:ml-[6%] lg:px-16">
          <div className="relative max-w-2xl">
            ...
            <div className="relative">
              ...
              <h1 className="mb-4 text-4xl font-bold leading-tight tracking-[.1em] sm:text-5xl lg:mb-5 lg:text-7xl">READ THE EVIDENCE<span className="mt-2 block opacity-90 lg:mt-3">NOT THE PAYLOAD</span></h1>
            </div>
