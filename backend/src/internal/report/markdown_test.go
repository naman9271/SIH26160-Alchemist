...
func TestGenerateIncludesEvidenceFindingsAndLimits(t *testing.T) {
	...
	for _, expected := range []string{"Observed security score", "Perfect Forward Secrecy", "Actionable threat entries", "traffic.class", "ESP payloads were not decrypted", "UNKNOWN", "ANOMALY"} {
